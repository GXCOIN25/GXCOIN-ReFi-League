        ...
        <div className="max-w-7xl mx-auto px-4">
          <Tabs value={currentTab} onValueChange={setCurrentTab} className="w-full">
            <div className="mb-8 overflow-x-auto relative">
              <TabsList className="mobile-tabs-list w-full max-w-7xl mx-auto bg-black/80 backdrop-blur-md p-3 flex overflow-x-auto scroll-smooth gap-2 border border-green-500/20 relative">
