...
export const gameHeroes: GameHero[] = [
  ...
  },
  {
    ...
    description: "Powering GXCOIN's Decentralized Commodities Exchange. Supreme market coordinator orchestrating carbon credit trading, ensuring fair distribution of eco-profits while democratizing access to green technology investments.",
    element: "Carbon",
    rarity: "Legendary",
    color: "#2d5a27",
